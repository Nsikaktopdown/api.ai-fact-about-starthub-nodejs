...
const ABOUT_FACTS = new Set([
    'Start Innovation Hub Nigeria is an ICT firm with innovation lab in Uyo, Akwa Ibom State, South-South of Nigeria.',
    ' We are committed to helping technology startups with software and hardware ideas start up faster. '
]);

const STARTHUB_MEMBERSHIP = new Set([
    'Start Innovation Hub membership is open to those interested in technology innovation with deliberate intentions of contributing to Nigeria’s dream of becoming an IT driven economy.'
]);
...
const STARTHUB_IMAGES = [
    [
        'http://starthub.com.ng/wp-content/uploads/2017/01/start-innovation-hub-logo-large.png',
        'StartHub logo app '
    ],
    [
        'http://www.starthub.com.ng/wp-content/uploads/2014/09/starthub.png',
        'Starthub  logo'
    ]
];
...
const STARTHUB_LINK = 'http://starthub.com.ng/about-start-innovation-hub-nigeria/';
...
exports.factsAboutStartHub = (request, response) => {
    ...
    function unhandledDeepLinks(app) {
        if (app.hasSurfaceCapability(app.SurfaceCapabilities.SCREEN_OUTPUT)) {
            app.ask(app.buildRichResponse()
                .addSimpleResponse(`Welcome to Facts about StartHub! I'd really rather \
not talk about ${app.getRawInput()}. Wouldn't you rather talk about \
StartHub? I can tell you about StartHub or its memebership?. \
Which do you want to hear about?`)
                .addSuggestions(['About', 'Membership']), NO_INPUTS);
        } else {
            app.ask(`Welcome to Facts about StartHub! I'd really rather \
not talk about ${app.getRawInput()}. \
Wouldn't you rather talk about StartHub? I can tell you about \
StartHub or its memebership. Which do you want to hear about?`,
                NO_INPUTS);
        }
    }
    ...
    function tellFact(app) {
        ...
        if (factCategory === FACT_TYPE.HISTORY) {
            ...
            let factPrefix = 'Okay, here\'s a Membership fact. ';
...
StartHub, or its membership. Which one do you want to \
...
about the ${currentCategory} of StartHub. I could tell you about its \
